...
export default function TimeLine({ Updates, isAdmin, onDelete } : timeLineProps ) {
    ...
    const totalWidth = basic + (Updates.length * itemWidth) + itemWidth;

    const extendHR = `${totalWidth}px`;
    ...
    return (
        <div className={'w-[95%]'}>
            <div className={'relative w-full ml-1  h-100 overflow-x-scroll md:mx-6 mt-6 bg-white shadow-big border-3 '}>
                    ...
                    {Updates.map((truc, index:number) => {
                        return(
                            <div
                                ...
                                style={{ left: `${basic + (index * itemWidth)}px` }}>
