    ...
    return (
      <div className={' min-h-screen bg-bg flex flex-col'}>
        <main className={'w-full flex-1'}>
          ...
          <div className={'bg-white ml-1 w-[95%] md:w-fit p-6 shadow-big border-3  md:ml-6'}>
            <h1 className={'text-4xl md:text-6xl font-black font-title'}>Bienvenue sur votre espace!</h1>
          ...
          <TimeLine Updates={updates}/>
            ...
            <div className={'flex flex-col w-full md:flex-row md:w-[95%] gap-6 items-stretch justify-center mt-6 md:mx-6 ml-1'}>
